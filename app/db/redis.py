...
class RedisClient:
    ...
    def set_current_week_games(self, games: List[Dict[str, Any]]) -> bool:
        ...
        try:
            ...
            self._client.setex(key, settings.REDIS_TTL, json.dumps(games))
    ...
    def set_access_token(self, token: str, expires_in: int = 7200) -> bool:
        ...
        try:
            ...
            self._client.setex(key, expires_in - 300, token)  # 提前5分钟过期
            return True
        except Exception as e:
    ...
    def set_jsapi_ticket(self, ticket: str, expires_in: int = 7200) -> bool:
        ...
        try:
            ...
            self._client.setex(key, expires_in - 300, ticket)
            return True
        except Exception as e:
