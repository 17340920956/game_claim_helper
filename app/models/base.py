...
class FreeGame(Base):
    ...
    image_url = Column(String(512), nullable=True, comment='封面图片链接')
    link = Column(String(512), nullable=True, comment='Epic游戏页面链接')
    offer_id = Column(String(128), nullable=True, comment='Epic offer ID，用于领取')
    namespace = Column(String(128), nullable=True, comment='Epic 命名空间，用于领取')
