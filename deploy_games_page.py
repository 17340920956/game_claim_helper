...
def main():
    ...
    try:
        ...
        scp.put("/tmp/game_claim_helper_v2.tar.gz", "/tmp/game_claim_helper_v2.tar.gz")
        print("上传完成!")
        ...
        # 3. 解压代码
        print("\n3. 解压代码...")
        run_command(client, f"echo '{PASSWORD}' | sudo -S bash -c 'cd {REMOTE_PATH} && tar xzf /tmp/game_claim_helper_v2.tar.gz --overwrite 2>/dev/null || true'", "解压代码")
